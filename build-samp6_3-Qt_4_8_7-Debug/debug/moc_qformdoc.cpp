...
static const char qt_meta_stringdata_QFormDoc[] = {
    "QFormDoc\0"
};
...
const QMetaObjectExtraData QFormDoc::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QFormDoc::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QFormDoc,
      qt_meta_data_QFormDoc, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QFormDoc::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QFormDoc))
